...
let projects = [
  {
    ...
    description: 'Somos Qonexia, te ofrece la mayor variedad de productos tecnológicos e innovadores para tu entretenimiento. Esta página no es oficial :)',
  ...
  },
  {
    ...
    description: 'Una pagina dedicada a la programación en Turbo C 2.0, donde puedes tener acceso a múltiples códigos y documentación para facilitar su uso y estudio.',
