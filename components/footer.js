        ...
        <>
            <footer className="footer">
                ...
                <div className="iframe-container">
                    <iframe title="status profile" src="https://github-readme-stats.vercel.app/api?username=Miguelhg2351&show_icons=true&hide_border=true&title_color=fff&icon_color=ffffff&bg_color=09f&text_color=fff" frameBorder="0"></iframe>
                </div>
                <div className="footer-info">
                    ...
                    <div className="img-footer">
                        <img src="/images/logo-no-background.png" loading="lazy" className="responsive-img" style={{verticalAlign: 'bottom'}} alt="Logo del sitio web"/>
                    </div>
                </div>
            </footer>
